...
const TestMonialsSection = () => {
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="md:flex mx-2 lg:mx-50 md:gap-5 mt-14 ">
        {dummyTestimonial.map((testimonial, index) => (
          <div key={index} className="text-sm text-left border-1 mt-8 md:mt-0  border-gray-500/30 pb-6 rounded-lg bg-white shadow[0px_4px_15px_0px] shadow-black/5 overflow-hidden  ">
            ...
            <a href="#" className="text-blue-500 hover:text-blue-500/90  px-5">Read more</a>
          </div>
        ))}
      </div>
    </div>
